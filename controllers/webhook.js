...
async function handler (req, res)  {
  console.log('🚀 ~ file: webhook.js:12 ~ req.method:', req.method)
  ...
  try {
    ...
    const event = stripe.webhooks.constructEvent(
      payload,
      sig,
      'whsec_58e7f4c8d7d88961ef59397fb1dbadb0a84ce61637b88bf8b67e275a6ecbc716'
    )

    console.log('🚀 ~ file: webhook.js:25 ~ event:', event)
